    ...
    <div className="bg-gray-100 dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700">
            ...
            <div className="px-4 pt-2 flex flex-wrap gap-2">
                {magicSuggestions.map((suggestion, i) => (
                    <button 
                        ...
                        className={`px-3 py-1 text-sm rounded-full ${themeClasses.text} bg-opacity-20 hover:bg-opacity-30 dark:bg-opacity-30 dark:hover:bg-opacity-40`}
                        style={{ backgroundColor: themeClasses.style?.backgroundColor ? `${themeClasses.style.backgroundColor}40` : '' }}
                    >
                        {suggestion}
                    </button>
                ))}
        ...
        <div className="relative p-4 flex items-center space-x-3">
          ...
          <input
            ...
            className={`flex-1 bg-gray-200 dark:bg-gray-700 rounded-full py-2.5 px-4 focus:outline-none focus:ring-2 text-gray-800 dark:text-gray-200 placeholder-gray-500 dark:placeholder-gray-400 ${themeClasses.ring}`}
            value={text}
          ...
          <button 
            ...
            className={`text-white p-2 rounded-full transition-colors disabled:opacity-50 disabled:cursor-not-allowed ${themeClasses.bg} ${themeClasses.hoverBg}`}
