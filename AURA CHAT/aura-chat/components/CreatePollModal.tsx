            ...
            >
                ...
                <div className="p-6 space-y-4">
                    ...
                    <div>
                     ...
                     {options.length < 5 && (
                        <button onClick={addOption} className={`flex items-center space-x-2 text-sm ${themeClasses.text} dark:${themeClasses.darkText} hover:underline`}>
                ...
                <footer className="p-4 bg-gray-50 dark:bg-gray-900/50 flex justify-end">
                    <button 
                        ...
                        className={`px-4 py-2 rounded text-white disabled:opacity-50 disabled:cursor-not-allowed ${themeClasses.bg} ${themeClasses.hoverBg}`}
