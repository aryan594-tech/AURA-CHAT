                    ...
                    <form onSubmit={handleSubmit}>
                        <div className="relative mb-4">
                            ...
                            <input
                                ...
                                placeholder="0"
                                className={`w-full bg-gray-100 dark:bg-gray-700 text-gray-900 dark:text-white text-4xl font-bold pl-10 pr-4 py-3 rounded-lg border-2 border-transparent focus:outline-none focus:ring-2 ${themeClasses.ring} ${themeClasses.border}`}
                                autoFocus
                                required
                                min="1"
                                step="any"
                        ...
                        <div className="mb-6">
                            <input
                                ...
                                className={`w-full bg-gray-100 dark:bg-gray-700 text-gray-800 dark:text-gray-200 px-4 py-2 rounded-lg border-2 border-transparent focus:outline-none focus:ring-2 ${themeClasses.ring}`}
                        ...
                        <button 
                            ...
                            className={`w-full text-white font-bold py-3 px-4 rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex justify-center items-center ${themeClasses.bg} ${themeClasses.hoverBg}`}
