            ...
            <div className="p-2">
                 ...
                 >
                    <div className="relative">
                        ...
                        />
                        <div 
                            className={`absolute -bottom-1 -right-1 rounded-full border-2 border-white dark:border-gray-900 ${themeClasses.bg}`}
                    ...
                    <ul>
                        {contactsWithStatus.map(contact => (
                            <li key={contact.id}>
                                ...
                                >
                                    <div 
                                        className={`p-0.5 border-2 rounded-full ${themeClasses.border}`}
                                        style={{ borderColor: themeClasses.style?.backgroundColor }}
                                    >
